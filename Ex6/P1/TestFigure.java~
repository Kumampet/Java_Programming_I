...
class Rect extends Shape{
	...
	return 2*l_side + 2*s_side;
    }
    public double getVol(){
	return l_side *s_side;
    }
    public String toString() {
      return "ClassName: " + getClass().getName() + " Side: " + l_side + "cm, " +s_side + "cm "+ "Object Name: " + name;
    }
}
...
class TestFigure{
	...
	Circle crl1 = new Circle("crl1", 5.0);//円
	...
	System.out.println("Radius: " + crl1.getRad() + "cm  Area: " + crl1.getVol() + "㎠ " +crl1.toString());
	System.out.println("Side_Sum: " + rect1.getSide() + "cm Area: " + rect1.getVol() + "㎠ " +rect1.toString());
